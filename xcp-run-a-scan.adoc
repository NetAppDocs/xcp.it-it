...
Inoltre, per le condivisioni SMB, è possibile ottenere il numero di file ADS (Alternate Data Streams) per ogni estensione di file selezionando la casella per GLI ANNUNCI prima di eseguire una scansione.
...
Inoltre, per le condivisioni SMB, è possibile ottenere il numero di file ADS (Alternate Data Streams) per tipi diversi selezionando la casella per GLI ANNUNCI prima di eseguire una scansione.
