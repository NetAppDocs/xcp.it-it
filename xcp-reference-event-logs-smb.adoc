...
summary: Registri eventi SMB XCP 
---
= Registri eventi SMB XCP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Esaminare i registri eventi di esempio per XCP SMB.

La tabella seguente mostra i registri eventi per XCP SMB.

[cols="20,40,40"]
|===
| ID evento | Modello di evento | Esempio di evento 
