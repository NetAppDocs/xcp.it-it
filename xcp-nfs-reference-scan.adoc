...
NOTE: I report XCP (.csv, .html) vengono salvati nella posizione del catalogo specificata nella `xcp.ini` file. I file vengono memorizzati in `<catalog path>/catalog/indexes/1/reports` cartella. È possibile visualizzare i rapporti di esempio nell'appendice.
