...
---
= XCP v1.9.1 - Note di rilascio
:allow-uri-read: 


Il link:https://library.netapp.com/ecm/ecm_download_file/ECMLP2884968["XCP v1.9.1 - Note di rilascio"^] descrivere nuove funzionalità, note sull'aggiornamento, problemi risolti, limitazioni note e problemi noti.
