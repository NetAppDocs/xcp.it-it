...
summary: Registri eventi NFS XCP 
---
= Registri eventi NFS XCP
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Esaminare i log eventi di esempio per XCP NFS.

La tabella seguente mostra i registri eventi per XCP NFS.
